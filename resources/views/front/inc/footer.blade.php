        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="single-footer-widget footer_1">
                    <a href="index.html"> <img src="{{asset('front/img/' . $sett->logo)}}" alt=""> </a>
            ...
            <div class="col-sm-6 col-md-4 col-xl-4">
                <div class="single-footer-widget footer_2">
                    ...
                    <div class="social_icon">
                        <a href="{{asset('front/img/' . $sett->fb)}}"> <i class="ti-facebook"></i> </a>
                        <a href="{{asset('front/img/' . $sett->twitter)}}"> <i class="ti-twitter-alt"></i> </a>
                        <a href="{{asset('front/img/' . $sett->insta)}}"> <i class="ti-instagram"></i> </a>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-md-4">
                <div class="single-footer-widget footer_2">
                    ...
                    <div class="contact_info">
                        <p><span> Address :</span> {{ $sett->address . ',' . $sett->country}}  </p>
